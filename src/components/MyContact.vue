    ...
    <section id="contact">
      ...
      <form  @submit.prevent="sendEmail()">
        ...
        <div class="colonnes ">
          ...
          <input class="style" type="text"  name="firstName" id="senderName" />
        </div>
        <div class="colonnes ">
          <label for="e.mail">e.mail</label>

          <input class="style" type="text"  name="e.mail" id="senderEmail" />
        </div>

        <div class="colonnes ">
          <label for="message">Message</label>
          <textarea class="style2" type="text"  name="message" id="emailMessage"></textarea>
        </div>
        <div class="colonnes">
